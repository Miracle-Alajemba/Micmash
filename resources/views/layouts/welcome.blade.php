            ...
            <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block">Explore events happening near you</span>
                    ...
                    <p class="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
                        ...
                        festivals, find your next experience here smoothly.
                    </p>
                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="text-sm leading-relaxed text-gray-100">
                            Join a growing community attending events near you. Whether it’s tech workshops or music
                            festivals, discover your next experience effortlessly
                        </p>
                        <!-- Social Icons -->
